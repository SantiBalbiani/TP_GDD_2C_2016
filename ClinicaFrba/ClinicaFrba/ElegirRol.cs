...
namespace ClinicaFrba
{
    public partial class ElegirRol : Form
    {
        ...
        private void ElegirRol_Load(object sender, EventArgs e)
        {
            ...
            string query = "select r.nombre,r.idRol from SELECT_GROUP.Usuario as u,SELECT_GROUP.Rol as r, SELECT_GROUP.Usuario_Por_Rol as UXR where u.nombreUsuario = '" + usuarioLogeado + "' and u.idUsuario = UXR.usuario_username and r.idRol = URX.rol_idRol";
